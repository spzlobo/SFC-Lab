...
cookie=0x1110070001170254, table=1, priority=40000,
  nsi=254,nsp=117,reg0=0x1,in_port=0
  actions=
...
cookie=0x1110010001170255, table=11,
  ...
  actions=
    move:NXM_NX_TUN_ID[0..31]->NXM_NX_NSH_C2[], # MoveTunnel ID in Context Header 2
    push_nsh, # Create NSH
...
cookie=0x1110010001170255, table=11,
  ...
  actions=
    move:NXM_NX_TUN_ID[0..31]->NXM_NX_NSH_C2[], # Move Tunnel ID in Context Header 2
    push_nsh,
      load:0x1->NXM_NX_NSH_MDTYPE[], # 1
      load:0x3->NXM_NX_NSH_NP[], # 3
      load:0xc0a80003->NXM_NX_NSH_C1[], # 192.168.0.3 -> Node with SF
...
cookie=0x1110060001170254, table=11,
  ...
  actions=
    ...
    resubmit(0,1) # resubmit in port 0 table 1
```
...
```bash
cookie=0x14, table=0,
  priority=250,nsp=117
  actions=
    goto_table:152

cookie=0x1110070001170254, table=1, priority=40000,
  nsi=254,nsp=117,reg0=0x1,in_port=7
  actions=
    pop_nsh, # Decapsulation
    goto_table:21
...
cookie=0xba5eba1100000104, table=158, priority=660,
  ...
  actions=
    ...
    move:NXM_NX_NSH_NP[]->NXM_NX_NSH_NP[], # Copy Next Protocol
    move:NXM_NX_NSI[]->NXM_NX_NSI[], # Copy Service Path Index
    move:NXM_NX_NSP[0..23]->NXM_NX_NSP[0..23], #  Copy Service Path Identifier
    move:NXM_NX_NSH_C1[]->NXM_NX_TUN_IPV4_DST[], # Move NSH Context Header 1 into Tunnel IPv4 dst (192.168.0.3)
    move:NXM_NX_NSH_C2[]->NXM_NX_TUN_ID[0..31], # Move NSH Context Header 2 into Tunnel ID (?)
...
cookie=0xba5eba1100000101, table=158, priority=655,
  ...
  actions=
    move:NXM_NX_NSH_MDTYPE[]->NXM_NX_NSH_MDTYPE[], # Copy NSH MD Type 1
    move:NXM_NX_NSH_NP[]->NXM_NX_NSH_NP[], # Copy Next Protocol
    move:NXM_NX_NSH_C1[]->NXM_NX_NSH_C1[], # Copy Context Header 1
    move:NXM_NX_NSH_C2[]->NXM_NX_NSH_C2[], # Copy Context Header 2
    move:NXM_NX_TUN_ID[0..31]->NXM_NX_TUN_ID[0..31], # Move NSH Context Header 2 into Tunnel ID (?)
    load:0x4->NXM_NX_TUN_GPE_NP[], # Next Protocol NSH
